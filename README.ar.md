...
# XXD Panel 194｜نموذج محوري مشرق على قاعدة موقع
...
نموذج محوري مشرق على قاعدة موقع
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 194 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-194`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-194 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-194-prompt.en.md) أو [بالصينية](references/xxd-panel-194-prompt.zh-CN.md).
